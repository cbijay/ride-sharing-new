...
It is a ride sharing app built using react as a frontend and express as a backend. On client side React query has been used to fetch api requests, Redux and tookit for state management, react testing library and cypress for testing.
